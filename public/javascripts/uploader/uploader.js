...
(function (window) {
    ...
    function uploader(url,pid, data, files) {
        this._files = files;
        this._data = data;
        this._url = url;
        this._projectID = pid;
    ...
    uploader.prototype = {
        ...
        send: function () {
            ...
            var url = this._url + "?rep=" + $("#productid").val() + "&mp=" + $("#midPath").val();
    ...
    var uploaderFactory = {
        send: function (url,pid, data, files, callback) {
            var insUploader = new uploader(url, pid, data, files);
